...
from researchops.apps.research.adapters import _detect_type, fetch_page, parse_doc
...
def test_pdf_url_html_content_rejected(tmp_dest: Path):
    ...
    with patch("researchops.apps.research.adapters.urllib.request.urlopen") as mock_open:
        mock_resp = MagicMock()
