...
def test_plan_refinement_triggers_rollback(tmp_run_dir: Path):
    ...
    from researchops.apps.research.schemas import PlanOutput, ResearchQuestion
    ...
    from researchops.core.orchestration.engine import Orchestrator
...
def test_conflict_scan_produces_json(tmp_run_dir: Path):
    ...
    from researchops.apps.research.schemas import Claim, SourceNotes
...
def test_source_strategy_enums():
    ...
    from researchops.core.config import RetrievalMode
...
def test_source_notes_has_bibliographic():
    ...
    from researchops.apps.research.schemas import SourceNotes
...
def test_eval_result_has_new_metrics():
    ...
    from researchops.apps.research.schemas import EvalResult
